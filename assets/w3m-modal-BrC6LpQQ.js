import{p as pe,s as me,q as he,t as ve,M as g,u as ee,R as l,i as v,r as E,a as f,b as a,v as j,e as te,o as ie,j as m,f as H,k as fe,x as k,E as G,O as T,C as M,y as F,l as $,A as D,T as ge,z as be,c as ye,h as xe}from"./core-DU8rFQFL.js";import{c as u,n as d,r as w,o as V,U as Ce}from"./index-BF5nheG2.js";import"./index-C-jbe66l.js";import"./WalletIsland-rl6jQVSj.js";import"./index.es-DpfL7C5M.js";const p=ve({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(n){return he(p,()=>n(p))},subscribeKey(n,e){return me(p,n,e)},showTooltip({message:n,triggerRect:e,variant:t}){p.open=!0,p.message=n,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
